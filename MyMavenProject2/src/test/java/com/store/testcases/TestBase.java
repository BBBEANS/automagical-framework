...
public class TestBase {
	...
	public void setupSuite() {
		...
		Reporter.log("Setup complete. Test may start.", true);
		
	}

	@BeforeClass
	public void setup() {
		Reporter.log("Preparing to open browser", true);
	...
	@Test
	public void test1() {
		Reporter.log("Preparing to open URL", true);
	...
	public void getResult(ITestResult result) {
		Reporter.log("Preparing to capture test result", true);
		...
		Reporter.log("Test result captured", true);
	}
